...
<div class="page-content">
    ...
    <div class="text-right mb-2">
        <a href="fpdf/reporteUsuario.php" target="_blank" class="btn btn-primary"><i class="far fa-file-pdf"></i> Generar Reporte </a>
    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header d-flex justify-content-between">
                                <h5 class="modal-title w-100" id="exampleModalLabel<?= $datos->id_usuario ?>">Modificar Usuario</h5>
