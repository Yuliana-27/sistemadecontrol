...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('../../public/img-inicio/logo2.png', 250, 5, 20); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE ALUMNOS "), 0, 1, 'C', 0);
      $this->Ln(7);
...
while ($datos_reporte = $consulta_reporte_empleado->fetch_object()) {
   ...
   $pdf->Cell(130, 10, utf8_decode($datos_reporte->nombre ." ".$datos_reporte->apellido), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->dni), 1, 0, 'C', 0);
   $pdf->Cell(100, 10, utf8_decode($datos_reporte->nomCargo), 1, 1, 'C', 0);
   
}


$pdf->Output('Reporte_Alumno.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)