...
<div class="page-content">
    ...
    include "../controlador/controlador_modifcar_cargo.php";
    ...
    <div class="text-right mb-2">
        <a href="fpdf/reporteCargo.php" target="_blank" class="btn btn-primary"><i class="far fa-file-pdf"></i> Generar Reporte </a>
    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header d-flex justify-content-between">
                                <h5 class="modal-title w-100" id="exampleModalLabel<?= $datos->id_cargo ?>">Modificar Cargo</h5>
